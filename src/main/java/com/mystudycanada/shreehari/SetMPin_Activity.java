...
import com.mystudycanada.shreehari.API.SetMPINRequest;
...
public class SetMPin_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("profile_pic",Name+LastName+profile_pic);
        ...
        findViewById(R.id.done).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(et1.getText().toString().isEmpty()){
                  ...
                  //  MPIN(Password, userSession.getFirebaseToken());
    ...
    public void Set_MPIN(final String mpin,final  String token) {
        ...
        SetMPINRequest loginRequest = new SetMPINRequest(mpin,token, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                Log.e("ResponseLogin", response + " null");
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                progressDialog.dismiss();
                session.logout();
                Intent intent = new Intent(SetMPin_Activity.this,Login_Activity.class);
                startActivity(intent);
                finish();
