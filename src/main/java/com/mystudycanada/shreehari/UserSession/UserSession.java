...
public class UserSession {
    ...
    public static final String KEY_STUDENTLEVEL = "KEY_STUDENTLEVEL";
    public static final String KEY_STUDENTBATCH = "KEY_STUDENTBATCH";
    ...
    public String getSlevel() {
        return pref.getString(KEY_STUDENTLEVEL, "");
    }
    public String getSBatch() {
        return pref.getString(KEY_STUDENTBATCH, "");
    }
    public void setSlevel(String FIRST_TIME) {
        pref.edit().putString(KEY_STUDENTLEVEL, FIRST_TIME).apply();
    }public void setSBatch(String FIRST_TIME) {
        pref.edit().putString(KEY_STUDENTBATCH, FIRST_TIME).apply();
    }
