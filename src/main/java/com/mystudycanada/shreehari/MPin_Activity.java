...
import com.mystudycanada.shreehari.API.CheckMPINlRequest;
...
public class MPin_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UserSessionFirebase userSessionFirebase = new UserSessionFirebase(getApplicationContext());
        ...
        findViewById(R.id.done).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(et1.getText().toString().isEmpty()){
                    ...
                    Log.e("Aaa",userSession.getFirebaseToken());
    ...
    public void Check_MPIN(final String device_token,final  String mPin) {
        ...
        Log.e("Aaa",device_token+"---"+mPin+"---"+session.getAPIToken());
        CheckMPINlRequest loginRequest = new CheckMPINlRequest(device_token,mPin, new Response.Listener<String>() {
                ...
                try {
                   ...
                   // Toast.makeText(MPin_Activity.this,jsonObject.getString("ResponseMsg"),Toast.LENGTH_SHORT).show();
                    if (jsonObject.getInt("ResponseCode")==200) {
                        ...
                        ServerUtils.IsApplicationOpen = true;
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                session.logout();
                Intent intent = new Intent(MPin_Activity.this,Login_Activity.class);
                startActivity(intent);
                finish();
                progressDialog.dismiss();
    ...
    protected void onStart() {
        super.onStart();
        if(ServerUtils.IsApplicationOpen){
            Intent intent=new Intent(MPin_Activity.this, HomeActivity.class);
            startActivity(intent);
            finish();
        }
