...
public class GetExamRequest extends StringRequest {
    ...
    public GetExamRequest(String page,String standard_id, String batch_id, Response.Listener<String> listener, Response.ErrorListener errorListener) {
        super(Method.GET, ServerUtils.BASE_URL+"get-exams?standard_id="+standard_id+"&batch_id="+batch_id+"&page="+page, listener, errorListener);
