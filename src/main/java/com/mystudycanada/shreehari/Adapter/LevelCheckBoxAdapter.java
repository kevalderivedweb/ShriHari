...
public class LevelCheckBoxAdapter extends RecyclerView.Adapter<LevelCheckBoxAdapter.MyViewHolder> {

    private final OnItemClickListener listener;
    private ArrayList<CoachingLevelModel> mDataset;
    ...
    public LevelCheckBoxAdapter(ArrayList<CoachingLevelModel> categoryModels, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.bachesname.setText(mDataset.get(position).getCoachinglevel());
