...
import com.mystudycanada.shreehari.Model.ResultModel;
...
public class ResultAdapter extends RecyclerView.Adapter<ResultAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.name.setText(mDataset.get(position).getFirstName() + " "+ mDataset.get(position).getLastName() + " (" + mDataset.get(position).getCoaching()+")");
