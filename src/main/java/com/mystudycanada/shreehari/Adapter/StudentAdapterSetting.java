...
public class StudentAdapterSetting extends RecyclerView.Adapter<StudentAdapterSetting.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        if(mDataset.get(position).getSelected().equals("1")){
            holder.name.setText(mDataset.get(position).getFirst_name()+" "+ mDataset.get(position).getLast_name() + " (Active)");
            ...
            holder.originalLayout.setBackground(holder.originalLayout.getContext().getResources().getDrawable(R.drawable.backgraound_white_round2));
